-- Optimize get_deal_detail RPC by removing company-wide data fetching
-- Contacts, company members, and crews are now fetched separately on-demand
...
BEGIN
  ...
  -- Return combined result (without contacts, companyMembers, crews)
