-- RPC to accept a quote and create invoice in one atomic transaction
-- This replaces multiple round trips in the quote acceptance flow
...
BEGIN
  ...
  -- 2. Update quote with acceptance details
  UPDATE quotes
  SET
    status = 'accepted',
