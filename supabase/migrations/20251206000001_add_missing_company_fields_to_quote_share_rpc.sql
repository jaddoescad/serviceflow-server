-- Add missing company fields to get_public_quote_share RPC
-- Adds: tax_rate, physical_company_name, logo_url, review_url, proposal_terms_template_content
-- Also adds signature_type to quote object
...
BEGIN
  ...
  SELECT
    ...
    json_build_object(
      'id', comp.id,
      'name', comp.name,
      'physical_company_name', comp.physical_company_name,
      'email', comp.email,
      ...
      'review_url', comp.review_url,
      'proposal_terms_template_content', comp.proposal_terms_template_content
    ),
  ...
  SELECT COALESCE(json_agg(
    json_build_object(
      ...
      'signature_text', cho.signature_text,
      'signature_type', cho.signature_type,
