-- ============================================================================
-- Update accept_change_order_with_invoice RPC to accept signature_type
-- ============================================================================
...
BEGIN
  ...
  -- 10. Update change order (with signature_type)
  ...
  SET
    ...
    signature_type = COALESCE(p_signature_type, 'type'),
