-- Update get_deal_detail RPC to include author display names in deal notes
-- This eliminates the need to fetch all company members just to display note authors
